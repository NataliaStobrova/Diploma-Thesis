...
% ylim([500000 2000000])
% legend({'počet prispievateľov (posun\_doch\_vek_{m/z} = 0)' ,'počet poberateľov (posun\_doch\_vek_{m/z} = 0)', 'počet prispievateľov (posun\_doch\_vek_{m/z} = 2)' ,'počet poberateľov (posun\_doch\_vek_{m/z} = 2)'},'Location','northeast')
