...
% figure
% hold on
% scatter(pocet_rokov_2_pilier_m_predpoved(1:end,1), doSocPoist, 25, 'filled', 'b') % 'b' pre posun_doch_vek_m/z = 2
% hold on
% scatter(pocet_rokov_2_pilier_m_predpoved(1:end,1), vyplacanie_doch_m + vyplacanie_doch_z, 25, 'filled', 'm') % 'm' pre posun_doch_vek_m/z = 2
...
% figure
hold on
scatter(pocet_rokov_2_pilier_m_predpoved(1:end,1), deficit, 25, 'filled', 'm')  % 'm' pre posun_doch_vek_m/z = 2
